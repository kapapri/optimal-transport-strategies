...
class GridWorldEnv(gym.Env):
    metadata = {"render_modes": ["human", "rgb_array", "ansi"], "render_fps": 4} # How it can be rendered
    ...
    def __init__(self, render_mode=None, size=5):
        ...
        # Each location is encoded as an element of {0, ..., `size`}^2, i.e. MultiDiscrete([size, size]). An observation may look like {"agent": array([1, 0]), "target": array([0, 3])}     
    ...
    # Auxiliary information. Manhattan distance between the agent and the target
    def _get_info(self):
        return {
